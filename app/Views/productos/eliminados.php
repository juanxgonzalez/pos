              ...
              <?php foreach ($datos as $dato) { ?>
                <tr>
                 <td><?php echo $dato['id']; ?></td>
                  ...
                  <td><a href="#" data-href="<?php echo base_url() . 'productos/reingresar/' . $dato['id']; ?>" data-bs-toggle="modal" data-bs-target="#modal-confirma" data-placement="top" title="Reingresar registro"><i class="fas fa-arrow-alt-circle-up"></i></a></td>
                </tr>
              <?php } ?>
            </tbody>
          </table>
